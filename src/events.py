...
async def setup_bot(*, session: SQLSession):
    ...
    try:
        ...
        whitelisted_apps_query_result = await sql_select(
            DBAppWhitelist,
            session=session,
        )
        ...
        auto_thread_query_result = await sql_select(
            DBAutoBridgeThreadChannels,
            session=session,
        )
...
async def bridge_reaction_add(
    *,
    ...
    try:
        ...
        already_bridged_reactions = await sql_select(
            DBReactionMap,
            where=(
...
async def unreact(
    *,
    ...
    try:
        ...
        bridged_reactions = await sql_select(
            DBReactionMap,
            where=conditions,
            session=session,
        )
        ...
        remaining_reactions = await sql_select(
            DBReactionMap,
